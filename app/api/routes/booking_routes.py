...
#     messages = {
#         NotificationType.booking_created: f"Your booking #{booking.id} for {subcat.name if subcat else 'N/A'} has been created successfully.",
#         NotificationType.booking_accepted: f"Your booking #{booking.id} for {subcat.name if subcat else 'N/A'} has been accepted by the vendor.",
...
#         # Send notifications based on status (now only here)
#         notification_type = {
