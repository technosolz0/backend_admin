...
# ✅ VENDOR ROUTES FIRST (more specific path: /api/vendor/*)
# This includes /api/vendor/subcategories
app.include_router(service_provider_routes.router, prefix="/api")

# ✅ GENERAL ROUTES AFTER (less specific path: /api/*)
# This includes /api/subcategories/
...
# 
# 1. /api/subcategories/          -> General subcategories (from sub_category_routes)
# 2. /api/vendor/subcategories    -> Vendor subcategories (from service_provider_routes)
# 3. /api/vendor/categories       -> Vendor categories (from service_provider_routes)
# 4. /api/vendor/login            -> Vendor login
# 5. /api/vendor/register         -> Vendor registration
# ... and all other vendor routes
# -------------------------
